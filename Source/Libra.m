...
ExpandLetters::usage="ExpandLetters[expr_,alphabet_,h_:II] distributes iterated integrals over the sums of letters. E.g., LettersExpand[II[{w1+w2,w1-2w2}],{w1,w2}] gives II[{w1,w1}]-2 II[{w1,w2}]+II[{w2,w1}]-2 II[{w2,w2}]. alphabet can be either list or a pattern.\nExamples:\n   LettersExpand[II[{w1+w2,w1-2w2}],{w1,w2}] \[DoubleLongRightArrow] II[{w1,w1}]-2 II[{w1,w2}]+II[{w2,w1}]-2 II[{w2,w2}].\n   LettersExpand[II[{w[0]+w[1],w[2]-w[3]}],_w] \[DoubleLongRightArrow] II[{w[0],w[2]}]-II[{w[0],w[3]}]+II[{w[1],w[2]}]-II[{w[1],w[3]}].";


ExpandLetters[expr_,alphabet_,h_:II]:=Module[{pat=Replace[alphabet,{a__}:>Alternatives[a]],l},
expr/.h[inds_?(MemberQ[Head/@#,Plus]&),x___]:>(Distribute[l@@inds]/.l->(h[{##},x]&))//.h[{a___,b_?(FreeQ[#,pat]&)*c_,d___},x___]:>b*h[{a,c,d},x]
]
